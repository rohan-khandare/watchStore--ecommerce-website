    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="jumbotron home-spacer" id="products-jumbotron">
                ...
                <p>We have the best cameras and watches for you. No need to hunt around, we have all in one place.</p>
            ...
            <div class="row text-center" id="watches">
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img\smart-watch-1.jpg" alt="">
                        <div class="caption">
                            <h3>Fastrack</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img\smart-watch-2.jpg" alt="">
                        <div class="caption">
                            <h3>BoAt stromCall</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img\smart-watch-3.jpg" alt="" >
                        <div class="caption">
                            <h3>FireBolt</h3>
                            <p>Price: Rs. 2000.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img id="s4"  src="img\smart-watch-5.jpg" alt="">
                        <div class="caption">
                            <h3>Samsung #439</h3>
